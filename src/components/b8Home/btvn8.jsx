...
import "./btvn8.scss";
import B8Login from "../b8Login/b8Login";
import {
...
import B8Signup from "../b8Signup/b8Signup";
  ...
  return (
    <div className="b8">
      <div className="b8Header">
        ...
        <Link to="/b8Login" className="b8Header__btn">
          Login
        </Link>
      </div>
      ...
      <div className="b8Ready">
        ...
        <Link to="/B8Signup" className="b8Ready__btn">
          Register
        </Link>
      </div>
